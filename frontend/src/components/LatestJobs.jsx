...
const LatestJobs = () => {
  ...
  return (
    <div className='max-w-6xl mx-auto my-20  '>
      {
        !user ? <h1 className='text-2xl text-center xs:text-4xl font-bold bg-orange-100 p-2 animate-bounce rounded-md border border-collapse  shadow-lg'><span className='text-[#720947]'>For Latest & Top </span>Job Openings Scroll Down...</h1> :
      ...
      <br />
      <div className='grid grid-cols-1 xs:grid-cols-3 gap-6 my-5 px-6 '>
